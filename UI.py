...
class QuizInterface:
    def __init__(self, quiz: Quiz):
        ...
        path_img = os.path.join(os.path.dirname(__file__), "images")
        true_image = PhotoImage(file=os.path.join(path_img, "true.png"))
        self.true_button = Button(image=true_image, highlightthickness=0, command=self.true_pressed)
        self.true_button.grid(row=2, column=0)

        false_image = PhotoImage(file=os.path.join(path_img, "false.png"))
